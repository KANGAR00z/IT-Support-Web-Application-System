...
// -----------------------------------------------------------------------------
// helper: แปลงค่าเวลาจาก DB ให้เป็นรูปแบบที่ JS อ่านได้ (new Date(...) ไม่ NaN)
// รับได้ทั้ง "2026-07-13 15:30:00.0" และ "2026-07-13T15:30:00"
...
function toIsoLocal_(rs, col) {
  ...
  return String(raw).trim()
    .replace(' ', 'T')        // "…13 15:30" -> "…13T15:30"
    .replace(/\.\d+$/, '');   // ตัดเศษวินาที ".0"
}
